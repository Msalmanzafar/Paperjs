...
// var smallVector = point2 + point1;

// var bigVector = smallVector * 3;

// console.log(bigVector, "big Vector")

// var smallVector = bigVector / 3;

// console.log(smallVector, "small Vector")


// Changing a Vector's Length=======================================

// var vector = new Point(50,90);
...
// //if we pass a value to normalize(10)
// console.log(vector.normalize(10))
// //if we multiplay a value with normalize() * 10
// console.log(vector.normalize() * 10)

// Changing a Vector's Angle=======================================
...
// console.log(vector.angle + 50, 'vector.angle + 50');
// console.log(vector.angle += 50, 'vector.angle += 50');

// // function onMouseUp(event){
// //     var point = event.vector + event.delta.rotate(90);
// //     console.log(point)
// // }
...
function onMouseUp(event) {
    ...
    console.log(vectorPrevious,'vectorPrevious')
}